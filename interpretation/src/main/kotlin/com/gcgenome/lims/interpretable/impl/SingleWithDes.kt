...
@Component
class SingleWithDes(om: ObjectMapper, snvRepo: SnvDao) : SnvInterpretable(om, VariantInterpreterSimpleKoKr(clinvarPhrase = ClinvarPhraseExplicitKoKr()), SnvUtil::toSnv, snvRepo) {
