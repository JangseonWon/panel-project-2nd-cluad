...
public class GermlineCollapseElement extends HTMLElementBuilder<HTMLDivElement, GermlineCollapseElement> implements CollapseElement<HTMLDivElement> {
    public static GermlineCollapseElement build(String id, long sample, JsPropertyMap<?> service) {
        return new GermlineCollapseElement(div(), id, sample, service);
    }
    ...
    private final SnvSimpleTableElement summary = GermlinePanelSheetBuilder.build();
    private final HTMLContainerBuilder<HTMLDivElement> _this;
    private final String id;
    private final long sample;
    private final JsPropertyMap<?> service;
    private final String code;
    private GermlineCollapseElement(HTMLContainerBuilder<HTMLDivElement> e, String id, long sample, JsPropertyMap<?> service) {
    ...
    @Override
    public GermlineCollapseElement that() {
        return this;
    }
