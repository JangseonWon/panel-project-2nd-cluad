...
public class BloodCancerCollapseElement extends HTMLElementBuilder<HTMLDivElement, BloodCancerCollapseElement> implements CollapseElement<HTMLDivElement> {
    public static BloodCancerCollapseElement build(String id, long sample, JsPropertyMap<?> service) {
        return new BloodCancerCollapseElement(div(), id, sample, service);
    }
    ...
    private BloodCancerCollapseElement(HTMLContainerBuilder<HTMLDivElement> e, String id, long sample, JsPropertyMap<?> service) {
    ...
    @Override
    public BloodCancerCollapseElement that() {
        return this;
    }
