...
public class TsoExpandElement extends HTMLElementBuilder<HTMLDivElement, TsoExpandElement> implements ExpandElement<HTMLDivElement> {
    public static TsoExpandElement build(String id, long sample, JsPropertyMap<?> service) {
        return new TsoExpandElement(div(), id, sample, service);
    }
    private final static Column[] columns = new Column[] {
            SnvTableElement.dropdown("report", "D.class",
                    ...
                    .pattern("Tier3").than( "#FFFFFF", "#FF8200").build(),
            ...
            SnvTableElement.text("aq", "AQ").horizontal("left").build(),
            SnvTableElement.text("sq", "SQ").horizontal("left").build(),
    ...
    private TsoExpandElement(HTMLContainerBuilder<HTMLDivElement> e, String id, long sample, JsPropertyMap<?> service) {
        super(e);
        _this = e;
        this.id = id;
        this.sample = sample;
    ...
    private void layout() {
        ...
        _this.css("work").style("height: 100vh;")
                ...
                .add(SomaticPanelSheetBuilder.build(columns)).add(NotAnalyzedElement.build())
