...
public class HrdExpandElement extends HTMLElementBuilder<HTMLDivElement, HrdExpandElement> implements ExpandElement<HTMLDivElement> {
    public static HrdExpandElement build(String id, long sample, JsPropertyMap<?> service) {
    ...
    private HrdExpandElement(HTMLContainerBuilder<HTMLDivElement> e, String id, long sample, JsPropertyMap<?> service) {
        super(e);
        _this = e;
        this.id = id;
        this.sample = sample;
